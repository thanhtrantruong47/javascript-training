...
function outLog() {
    for(let i = 0; i < b.length; i++)arr.push(b[i]); // push value to string b to arr
}
...
console.log(arr);
// example string
const sum = 10; // create variable sum = 10
const string = `Hey
is awesome! ${sum}`; // string + sum
// console.log(string); // log in client
// example for conditional
if (string.length > 20) console.log(string, "acces");
else console.log("err");

//# sourceMappingURL=index.2edf86a8.js.map
